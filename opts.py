...
def get_args_parser():
    ...
    parser.add_argument('--ngpu', default=1, type=int, help='gpu number when inference for ref-ytvos and ref-davis')
    ...
    parser.add_argument('--model_ckpt', type=str, default='checkpoint.pth')
    parser.add_argument('--test_num_ckpt', default=-2, type=int)
