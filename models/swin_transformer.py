...
class Backbone(BackboneBase):
    ...
    def __init__(self, name: str,
        ...
        # cfgs.update({'drop_path_rate': args.drop_path_rate})
        # print("--------------------------")
        # print(cfgs['drop_path_rate'])
...
def build_swin_backbone(args):
    ...
    backbone = Backbone(args.backbone, args.use_checkpoint, args.backbone_pretrained, args=args)
